...
for (i in 1312:length(list_of_cat_images)) {
...
image_crop_array <- array_reshape(image_crop_array, c(100, 224, 224, 1))
heatmap_crop_array <- array_reshape(heatmap_crop_array, c(100, 224, 224, 1))
...
model_input <- layer_input(shape = c(224, 224), dtype = 'float32', name = 'image_input')
main_network <- 
  model_input %>%
  layer_dense(units = 256, activation = 'relu', input_shape = c(224, 224)) %>%
