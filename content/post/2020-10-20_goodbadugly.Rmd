...
This is the complete code used to create the **ggplot2** graphs in my talk **The Good, the Bad and the Ugly: how (not) to visualize data** at this year's data2day conference. You can find the slides here.
