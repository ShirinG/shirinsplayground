---
title: "MünsteR Meetup on Blog Mining: Deriving the success of blog posts from metadata and text data."
draft: false
author: Shirin Glander
date: '2018-08-01'
categories: ["R", "meetup", "MünsteR"]
tags: ["meetup", "MünsteR", "text mining"]
thumbnailImagePosition: left
thumbnailImage: https://shiring.github.io/r_users_group/2017/05/20/map.png
metaAlignment: center
coverMeta: out
slug: meetup_august18
---

![](https://shiring.github.io/r_users_group/2017/05/20/map.png)

In our [next MünsteR R-user group meetup](http://meetu.ps/e/FDZ1D/w54bW/f) on **Tuesday, August 28th, 2018** Jenny Saatkamp will give a talk titled **Blog Mining: Deriving the success of blog posts from metadata and text data**.
You can RSVP here: [http://meetu.ps/e/F7zDN/w54bW/f](http://meetu.ps/e/FDZ1D/w54bW/f)
...
First, new insights into the blog posts and their success is gained using metadata. Therefore, diverse methods and R-packages are used such as H2O automatic machine learning, lime, clustering and basic explorative statistics. The sources of metadata are the blog itself, Google Analytics and the SEO-Tool Ahrefs.
