...
A few colleagues of mine and I from [codecentric.ai](https://www.codecentric.de/kuenstliche-intelligenz/) are currently working on developing a free online course about machine learning and deep learning. As part of this course, I am developing a [series of videos](https://www.youtube.com/codecentricAI) about machine learning basics - the first video in this series was about Random Forests.

You can find the video on [YouTube](https://youtu.be/ieF_QjVUNEQ) but as of now, it is only available in German. Same goes for the [slides](https://codecentric.slides.com/shiringlander/ml_basics_rf), which are also currently German only.

I did however translate my script:

---

![](https://shiring.github.io/netlify_images/ml_basics_rf.png)
...
![https://commons.wikimedia.org/wiki/File:Random_forest_diagram_complete.png](https://upload.wikimedia.org/wikipedia/commons/7/76/Random_forest_diagram_complete.png)
...
Examples in R can be found here: [https://shirinsplayground.netlify.com/2018/06/intro_to_ml_workshop_heidelberg/](https://shirinsplayground.netlify.com/2018/06/intro_to_ml_workshop_heidelberg/).
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/ieF_QjVUNEQ" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>

# Slides

<iframe src="//codecentric.slides.com/shiringlander/ml_basics_rf/embed" width="576" height="420" scrolling="no" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>