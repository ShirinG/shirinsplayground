...
Keras comes with a number of built in [callbacks](https://keras.rstudio.com/articles/training_callbacks.html). Callbacks are useful for optimizing/customizing your training runs and are used with the `fit()` function. Here, I'll show what callbacks come built into Keras and how to write your own custom callbacks.
